...
insert INTO Weather( name) VALUES ( 'very warm');
insert INTO Weather( name) VALUES ( 'warm');
insert INTO Weather( name) VALUES ( 'normal');
insert INTO Weather( name) VALUES ( 'cold');
insert INTO Weather( name) VALUES ( 'very cold');
insert INTO Weather( name) VALUES ( 'warm and rainy');
insert INTO Weather( name) VALUES ( 'cold and rainy');
...
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 1,'t-shirt','blue', 1, true,10,10,3);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 1,'t-shirt','red', 1, true,10,10,2);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 2,'pumps','red',1, false,10,10,2);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 2,'Vans','black',8, false,10,10,3);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 3,'mascara','black',1, false,10,10,2);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 5,'showergel','none',1, false,10,10,5);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 5,'toothbrush','purple', 1, false,10,10,5);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 1,'underwear','pink', 1, true,10,10,2);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 10,'drivers license','none', 3, false,10,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 8,'sea sickness tablets','none', 7, true,10,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 6,'sleeping mask','none', 1, false,10,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 11,'skis and sticks','none', 1, false,3,8,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 1,'cycling suit','green', 2, false,2,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 2,'cycling shoes','black', 2, false,2,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 2,'walking shoes','black', 8, false,10,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 8,'compeed','none', 8, false,10,10,4);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 8,'ear plugs','none', 6, false,10,10,4);
...
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id) VALUES ( 1,'rain coat','none', 1, false,10,6,5);
...
INSERT INTO item (dayDependency, itemColor, itemName, category_id, journeyType_id, personType_id, transport_id, weather_id)VALUES ( false,'none','transport tickets',12,4,5,1,2);
INSERT INTO item (category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id, personType_id)VALUES ( 1,'24','none', 1, false,1,2,4);
...
insert into journey (journeyName, numberDays, transport_id, travelZone_id, weather_id, journeyType_id)    values ( 'Graspop Metal Meeting', 3, 3, 2, 10, 9);
