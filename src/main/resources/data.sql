...
INSERT INTO item (id, category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id) VALUES (12, 11,'skis and sticks','none', 1, false,3,8);
...
INSERT INTO item (id, category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id) VALUES (17, 8,'ear plugs','none', 6, false,10,10);
...
INSERT INTO item (id, category_id, itemName, itemColor, transport_id, dayDependency, journeyType_id, weather_id) VALUES (19, 1,'rain coat','none', 1, false,10,6);
...
insert into journey (id, journeyName, numberDays, transport_id, travelZone, weather_id, journeyType_id)
    values (2, 'Ski in Sölden', 7, 3, 'abroad_shengen', 8, 3);
insert into journey (id, journeyName, numberDays, transport_id, travelZone, weather_id, journeyType_id)
